...
export function multiPassShaderGeneratedMesh() {
...
// Sharing textures and meshes is possible. But for simplicity each pass has it's own output texture and mesh in this example.
    ...
    const gridQuad = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>gridShader);
...
void main()
{
    ...
    const rippleTexture = PIXI.RenderTexture.create({
        width:200,
        height: 200
    });
    const rippleQuad = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>rippleShader);
...
void main()
{
    ...
    const noiseQuad = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>noiseShader);
...
void main()
{
    ...
    const waveTexture = PIXI.RenderTexture.create({

        width:200,
        height:200
    });
    const waveQuad = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>waveShader);
...
void main()
{
    ...
    const combineQuad = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>combineShader);
