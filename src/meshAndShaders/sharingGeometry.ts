...
export function sharingGeometry() {
...
`);
    ...
    const triangle = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>new PIXI.Shader(program, {
        uSamplerTexture: PIXI.Texture.from('examples/assets/bg_scene_rotate.jpg'),
    }));

    const triangle2 = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>new PIXI.Shader(program, {
        uSamplerTexture: PIXI.Texture.from('examples/assets/bg_rotate.jpg'),
    }));

    const triangle3 = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>new PIXI.Shader(program, {
