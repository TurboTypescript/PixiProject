...
`,
    ...
    const triangle = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>shader);


    const triangle2 = new PIXI.Mesh(geometry, <PIXI.MeshMaterial>shader2);
