...
`;
    ...
    for (let i = 0; i < 20; i++) {
        const maggot:any = PIXI.Sprite.from('https://pixijs.io/examples/examples/assets/maggot.png');
        ...
        maggot.original.copyTo(maggot.scale);
        maggots.push(maggot);
    }
...
// displacementFilter.padding = 0;
    ...
    function onPointerMove(eventData) {
        ...
        rings.position.copyTo(displacementContainer.position);
    }
