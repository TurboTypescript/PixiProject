...
export function twoDPlaneTiling() {
    const app = new PIXI.Application({ backgroundColor: 0x103322 });
    document.body.appendChild(app.view);

    const squareFar: any = new PIXI.Sprite(PIXI.Texture.WHITE);
...
// var squarePlane = new PIXI.projection.Sprite2d(PIXI.Texture.from('examples/assets/flowerTop.png'));
    const squarePlane: any = new PIXI.projection.Sprite2d(PIXI.Texture.WHITE);
