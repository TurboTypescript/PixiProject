...
// import 'pixi-layers'
// export function threeDCameraSpineLayers() {
...
//         const spritePlane: any = new PIXI.projection.Container3d();
...
//         alienContainer.children.forEach((alien: any) => {
...
//
//         alienContainer.children.forEach((plane:any) => {
